...
public class ModSword extends SwordItem {
    ...
    public ModSword(ToolMaterial tier, int dmg, float speed, double range, double knockback, AttackStyleEnum attackStyle, Settings props, String toolTipName, int linesAmt) {
