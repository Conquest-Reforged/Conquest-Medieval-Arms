...
public class ModAxe extends AxeItem {
    ...
    public ModAxe(ToolMaterial tier, float dmg, float speed, double range, double knockback, AttackStyleEnum attackStyle, Settings props, String toolTipName, int linesAmt) {
