...
public class ModSpear extends ToolItem implements Vanishable {
    ...
    public ModSpear(Settings props, String toolTipName, double range, double knockback, AttackStyleEnum attackStyle, ToolMaterial tier, int dmg, float speed, int linesAmt) {
        super(tier, props);
        this.range = range;
