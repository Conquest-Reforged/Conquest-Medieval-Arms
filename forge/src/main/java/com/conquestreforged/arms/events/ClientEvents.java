...
public class ClientEvents {
    ...
    public static void onMouseOver(RenderGameOverlayEvent.Post overlayEvent) {
        ...
        if (isExtendedReachItem(weapon.getItem()) && getEntityMouseOverExtension(reach) instanceof EntityHitResult) {
    ...
    private static HitResult getEntityMouseOverExtension (double reach) {
