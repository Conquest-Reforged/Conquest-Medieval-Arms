...
public class ItemInit {
    ...
    public static final Item.Settings genericCombatProps = new Item.Settings()
            .maxCount(1);
    public static final Item.Settings shieldProps = new Item.Settings()
            .maxCount(1)
            .maxDamage(336);
    ...
    //Ranged
    public static final RegistryObject<Item> STEPPE_RECURVE_BOW = ItemBuilders.registerTierlessWeapon("steppe_recurve_bow", ModBow.class, genericCombatProps.maxDamage(384),0);
    public static final RegistryObject<Item> ENGLISH_LONGBOW = ItemBuilders.registerTierlessWeapon("english_longbow", ModBow.class, genericCombatProps.maxDamage(384), 0);
    public static final RegistryObject<Item> HEAVY_WARBOW = ItemBuilders.registerTierlessWeapon("heavy_warbow", ModBow.class, genericCombatProps.maxDamage(384), 0);
    public static final RegistryObject<Item> SMALL_WARBOW = ItemBuilders.registerTierlessWeapon("small_warbow", ModBow.class, genericCombatProps.maxDamage(384), 0);
    public static final RegistryObject<Item> SHORTBOW = ItemBuilders.registerTierlessWeapon("shortbow", ModBow.class, genericCombatProps.maxDamage(384), 0);
    public static final RegistryObject<Item> LIGHT_CROSSBOW = ItemBuilders.registerTierlessWeapon("light_crossbow", ModCrossbow.class, genericCombatProps.maxDamage(465), 0);
    public static final RegistryObject<Item> MEDIUM_CROSSBOW = ItemBuilders.registerTierlessWeapon("medium_crossbow", ModCrossbow.class, genericCombatProps.maxDamage(465), 0);
    public static final RegistryObject<Item> HEAVY_CROSSBOW = ItemBuilders.registerTierlessWeapon("heavy_crossbow", ModCrossbow.class, genericCombatProps.maxDamage(465), 0);

    //Melee
    public static final List<RegistryObject<Item>> BASTARD_SWORD = ItemBuilders.registerSwordSet("bastard_sword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH,  genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> VIKING_BEARDED_AXE = ItemBuilders.registerAxeSet("viking_bearded_axe", 0, -3.1F, 10.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BEARDED_GREAT_AXE = ItemBuilders.registerAxeSet("bearded_great_axe", 0, -3.1F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BEARDED_AXE = ItemBuilders.registerAxeSet("bearded_axe", 0, -3.1F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> CROWBEAK_HATCHET = ItemBuilders.registerAxeSet("crowbeak_hatchet", 0, -3.1F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> LARGE_BEC_DE_CORBIN = ItemBuilders.registerSwordSet("large_bec_de_corbin", 0, -2.4F, 2.5D, 3.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BILL = ItemBuilders.registerSwordSet("bill", 0, -2.4F, 2.5D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BILL_HOOK = ItemBuilders.registerSwordSet("bill_hook", 0, -2.4F, 2.5D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BROADAXE = ItemBuilders.registerAxeSet("broadaxe", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> CRUSADER_SWORD = ItemBuilders.registerSwordSet("crusader_sword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> DOUBLE_FLAIL = ItemBuilders.registerSwordSet("double_flail", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> POLEHAMMER = ItemBuilders.registerSwordSet("polehammer", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> FLAIL = ItemBuilders.registerSwordSet("flail", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SPIKED_FLAIL = ItemBuilders.registerSwordSet("spiked_flail", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> FLAMMENSCHWERT = ItemBuilders.registerSwordSet("flammenschwert", 0, -2.4F,0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> FLANGED_MACE = ItemBuilders.registerSwordSet("flanged_mace", 0, -2.4F,0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> HORSEMANS_AXE = ItemBuilders.registerAxeSet("horsemans_axe", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> HUNTING_KNIFE = ItemBuilders.registerSwordSet("hunting_knife", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> LARGE_VIKING_SWORD = ItemBuilders.registerSwordSet("large_viking_sword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> LEAFBLADE_CLAYMORE = ItemBuilders.registerSwordSet("leafblade_claymore", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> LONGSWORD = ItemBuilders.registerSwordSet("longsword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> POLE_FLAIL = ItemBuilders.registerSwordSet("pole_flail", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> QUILLON_DAGGER = ItemBuilders.registerSwordSet("quillon_dagger", 0, -2.4F,-1.5D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SCIMITAR = ItemBuilders.registerSwordSet("scimitar", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SHESTOPYOR = ItemBuilders.registerSwordSet("shestopyor", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SHORTSWORD = ItemBuilders.registerSwordSet("shortsword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SHORTSWORD_WITH_GILDED_HILT = ItemBuilders.registerSwordSet("shortsword_with_gilded_hilt", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SPIKED_MACE = ItemBuilders.registerSwordSet("spiked_mace", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> STUDDED_BATTLE_AXE = ItemBuilders.registerAxeSet("studded_battle_axe", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> VIKING_SWORD = ItemBuilders.registerSwordSet("viking_sword", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> ZWEIHANDER = ItemBuilders.registerSwordSet("zweihander", 0, -2.4F, 0.0D, 0.0D, AttackStyleEnum.SLASH, genericCombatProps, metalTiers, 0);

    public static final List<RegistryObject<Item>> GLAIVE = ItemBuilders.registerLongWepSet("glaive", 2.5D,  0.0D, AttackStyleEnum.SLASH,0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> HEAVY_HALBERD = ItemBuilders.registerLongWepSet("heavy_halberd", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> HEAVY_VOULGE = ItemBuilders.registerLongWepSet("heavy_voulge", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> VOULGE = ItemBuilders.registerLongWepSet("voulge", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> WAR_SCYTHE = ItemBuilders.registerLongWepSet("war_scythe", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);

    public static final List<RegistryObject<Item>> SIMPLE_HALBERD = ItemBuilders.registerLongWepSet("simple_halberd",2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> SWISS_HALBERD = ItemBuilders.registerLongWepSet("swiss_halberd",2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> POLEAXE = ItemBuilders.registerLongWepSet("poleaxe", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> RANSEUR = ItemBuilders.registerLongWepSet("ranseur",2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);

    public static final List<RegistryObject<Item>> PITCHFORK = ItemBuilders.registerLongWepSet("pitchfork", 2.0D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);

    public static final List<RegistryObject<Item>> JOUSTING_LANCE = ItemBuilders.registerLongWepSet("jousting_lance", 4.0D, 0.0D, AttackStyleEnum.SLASH, 0, -4.0F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> BARDICHE = ItemBuilders.registerLongWepSet("bardiche", 2.0F, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> WINGED_SPEAR = ItemBuilders.registerLongWepSet("winged_spear", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
    public static final List<RegistryObject<Item>> WINGED_LEAF_SHAPED_SPEAR = ItemBuilders.registerLongWepSet("winged_leaf_shaped_spear", 2.5D, 0.0D, AttackStyleEnum.SLASH, 0, -2.9F, genericCombatProps, metalTiers, 0);
