...
public class EntityClientInit {
    ...
    public static void layers(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(ModelGenericHelmet.LAYER_LOCATION, ModelGenericHelmet::createHeadLayer);
        ...
        event.registerLayerDefinition(ModelBlueJoustingHelmet.LAYER_LOCATION, ModelBlueJoustingHelmet::createHeadLayer);
