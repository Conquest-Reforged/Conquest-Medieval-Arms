...
public class ModelBlueJoustingHelmet<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        CubeDeformation scale5 = new CubeDeformation(0.61F, 1.25F, 0.0F);
        ...
        //crest
        PartDefinition head5 = head4.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(4, 32).addBox(0.61F, -17.75F, -5.06F, 0.0F, 8.0F, 9.0F, scale4), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r0 = head4.addOrReplaceChild("cube_r0", CubeListBuilder.create().texOffs(26, 48).addBox(-2.0F, -17.75F, 0.0F, 4.0F, 7.0F, 0.0F, scale5), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r1 = head4.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(48, 40).addBox(-2.0F, -26.0F, -2.0F, 0.0F, 16.0F, 8.0F, scale6), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition cube_r2 = head4.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(48, 40).addBox(2.0F, -26.0F, -2.0F, 0.0F, 16.0F, 8.0F, scale6), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));
