...
public class ModelVikingHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "gilded_viking_helmet"), "main");

    public ModelVikingHelmet(ModelPart root) {
        super(root);
