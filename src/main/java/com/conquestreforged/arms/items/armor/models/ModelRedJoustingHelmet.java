...
public class ModelRedJoustingHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "red_crested_jousting_helmet"), "main");

    public ModelRedJoustingHelmet(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        CubeDeformation scale4 = new CubeDeformation(0.0F, 0.61F, 0.61F);
        CubeDeformation scale5 = new CubeDeformation(0.61F, 1.1F, 0.0F);
        ...
        //crest
        PartDefinition head5 = head4.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(3, 28).addBox(0.0F, -21.25F, -5.5F, 0.0F, 11.0F, 10.0F, scale4), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r0 = head4.addOrReplaceChild("cube_r0", CubeListBuilder.create().texOffs(25, 48).addBox(-2.0F, -20.75F, 0.0F, 4.0F, 10.0F, 0.0F, scale5), PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition cube_r1 = head4.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(45, 40).addBox(-2.0F, -29.0F, -2.0F, 0.0F, 16.0F, 8.0F, scale6), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, -0.3927F, 0.0F));

        PartDefinition cube_r2 = head4.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(45, 40).addBox(2.0F, -29.0F, -2.0F, 0.0F, 16.0F, 8.0F, scale6), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.3927F, 0.0F));
