...
public class ModelArabianHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "arabian_helmet"), "main");

    public ModelArabianHelmet(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        //PartDefinition head5 = head1.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(23, 48).addBox(-4.5F, -5.18F, -7.5F, 9.0F, 0.0F, 12.0F, scale0), PartPose.offset(0.0F, 0.0F, 0.0F));
