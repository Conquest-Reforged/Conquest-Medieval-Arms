...
public class ModelMongolHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "mongolian_spiked_helmet"), "main");

    public ModelMongolHelmet(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        CubeDeformation scale4 = new CubeDeformation(0.8F, 1.2F, 0.0F);
        ...
        PartDefinition head5 = head4.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(10, 28).addBox(-2.0F, -21.50F, 0.0F, 4.0F, 16.0F, 0.0F, scale4), PartPose.offset(0.0F, 0.0F, 0.0F));
