...
public class ModelCicakHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "cicak_helmet"), "main");

    public ModelCicakHelmet(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        CubeDeformation scale5 = new CubeDeformation(0.61F, 0.61F, 0.0F);
        ...
        PartDefinition head6 = head5.addOrReplaceChild("head5", CubeListBuilder.create().texOffs(4, 35).addBox(0.61F, -14.23F, -5.06F, 0.0F, 8.0F, 9.0F, scale4), PartPose.rotation(0.0F, 1.5708F, 0.0F));

        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(44, 36).addBox(-4.0F, -13.2F, -7.5F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
        //PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(44, 36).addBox(3.9F, -23.7F, -21.7F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -8.0F, 8.0F, -0.3927F, 0.0F, 0.0F));


        //PartDefinition crest1 = head5.addOrReplaceChild("crest1", CubeListBuilder.create().texOffs(4, 35).addBox(0.61F, -14.23F, -5.06F, 9, 8, 0, scale5), PartPose.offset(0.0F, 0.0F, 0.0F));
