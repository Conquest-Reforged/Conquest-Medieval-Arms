...
public class ModelYellowJoustingHelmet<T extends LivingEntity> extends HumanoidModel<T> {

    private final ModelPart head;

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(MOD_ID, "yellow_crested_jousting_helmet"), "main");

    public ModelYellowJoustingHelmet(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createHeadLayer() {
        ...
        PartDefinition cube_r0 = head4.addOrReplaceChild("cube_r0", CubeListBuilder.create().texOffs(18, 48).addBox(-6.5F, -19.5F, 0.0F, 13.0F, 13.0F, 0.0F, scale5), PartPose.offset(0.0F, 0.0F, 0.0F));
