...
public class ItemInit {
    ...
    public static void registerModItems() {
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.COMBAT).register(ItemInit::addItemsToIngredientItemGroup);
    }
    ...
    //Ranged
    public static final Item STEPPE_RECURVE_BOW = ItemBuilders.registerTierlessWeapon("steppe_recurve_bow", ModBow.class, genericCombatProps.durability(384),0);
    public static final Item ENGLISH_LONGBOW = ItemBuilders.registerTierlessWeapon("english_longbow", ModBow.class, genericCombatProps.durability(384), 0);
    public static final Item HEAVY_WARBOW = ItemBuilders.registerTierlessWeapon("heavy_warbow", ModBow.class, genericCombatProps.durability(384), 0);
    public static final Item SMALL_WARBOW = ItemBuilders.registerTierlessWeapon("small_warbow", ModBow.class, genericCombatProps.durability(384), 0);
    public static final Item SHORTBOW = ItemBuilders.registerTierlessWeapon("shortbow", ModBow.class, genericCombatProps.durability(384), 0);
    public static final Item LIGHT_CROSSBOW = ItemBuilders.registerTierlessWeapon("light_crossbow", ModCrossbow.class, genericCombatProps.durability(465), 0);
    public static final Item MEDIUM_CROSSBOW = ItemBuilders.registerTierlessWeapon("medium_crossbow", ModCrossbow.class, genericCombatProps.durability(465), 0);
    public static final Item HEAVY_CROSSBOW = ItemBuilders.registerTierlessWeapon("heavy_crossbow", ModCrossbow.class, genericCombatProps.durability(465), 0);
